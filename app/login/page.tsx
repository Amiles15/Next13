...
const page = () => {
  return (
    <>
      <div className="bg-center bg-no-repeat bg-[url('/src/matcha.jpg')] bg-gray-700 bg-blend-multiply">
        <div className="p-48 px-4 my-2 w-full ">
          <div className="">
            <form className="max-w-sm mx-auto border-white rounded-lg border-2 px-5">
